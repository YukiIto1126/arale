...
// 					.style("background", "rgba(0, 0, 0, 0.75)")
	...
	function baboComment(){
		...
		var coms = [
		 "〇〇高校が日本一まであと一点とリードです。頑張れ△△高校！"
		 ,"両校とも素晴らしい戦いを見せてくれています！白熱の大接戦。次のポイントは・・・。"
		 ,"応援が一層暑くなってきています。両校の応援団も選手と一緒に戦っています。"
		 ,"すばらしいプレーが出ました。会場のみなさんで讃えましょう"
		 ,"苦しいセットを死守しました！"
		 ,"大会一の大きなジャンプでしょうか！"
		 ,"見事なサーブが隅に決まりました。相手の選手も悔しい表情を浮かべています。連続得点です"
		 ,"〇〇高校の〇〇選手の強烈なアタックが相手コートに突き刺さりました。"
		 ,"ナイスレシーブ"
		 ,"△△高校の△△選手のブロックがここでも決まりました。体型を通じて３０ブロック目で驚異の記録となりました"
		 ];
