...
// 		return site_settings.graphInfoServiceSSL + site_settings.graphInfoServiceIP + "/BigScreen/" + str;
	    ...
	    $.ajax({
	        ...
	        complete: function(d){
	        	if(v.realtimeSecond > 0){
					...
					svg.setAttribute('style', 'left:500px; opacity: .8;');
					$("#divPanel" + i).append(svg);
					
					$("#divPanel" + i + " svg.loader").append(CreatePath({"class":"loader", "fill":"#FFF", "transform":"translate(25, 25)"}));
	...
	$("#container").css("background", "url('"+ MakePath("img/background.jpg") +"')");
	...
	var headerHtml = '<img style="height: 30px" alt="logo02" src="'+ MakePath("html/image/icon_softbank_blk.png") +'">';
	...
	setTimeout(function(){
		...
		location.href = url + "?js_fast_load=0&displayStyle=" + index;
	}, 1200000);
	this.finished=true;
}
